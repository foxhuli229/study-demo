<template>
  <div class="full-screen-two">
    <a href="javascript:;" :title="text" @click="toggleFullScreen">
      <span class="screen-two" :style="classStr" :class="{active: isFullScreen}" />
    </a>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    classStr() {
      ...
      const quanping = `background-image: url('${olmapUrl}/static/olmap/images/quanping.png')`
      const tuichuquanping = `background-image: url('${olmapUrl}/static/olmap/images/tuichuquanping.png')`
