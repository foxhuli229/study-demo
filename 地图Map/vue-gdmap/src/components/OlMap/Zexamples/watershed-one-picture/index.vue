<template>
  <div class="ol-map">
    ...
    <command-dispatch
      ...
      :tree-height="250"
      :zoom-in-falg="false"
      :export-box-falg="true"
      :layers-box-falg="false"
      :left-box-set-flag="true"
    ...
    >
      ...
      <template v-if="searchToolShow" #movePopup>
        <move-popup :is-full="true" v-if="eventTaskListShow" :popup-property="popupProperty" @handleBindUpdate="handleBindUpdate">
          <template #popupAll>
            <!--任务列表-->
            <event-task-list
        ...
        <move-popup v-else :is-full="true" :popup-property="popupProperty" @handleBindUpdate="handleBindUpdate" @closer-popup="handleIncidentToolBoxCloser">
          <template #popupAll>
            <!--事件-->
            <IncidentToolBox
...
export default {
  ...
  data() {
    return {
      buttonArray: [
        { id: '1', buttonName: '周边市州通信录' },
        { id: '2', buttonName: '新增突发事件' }
      ],
      ...
      incidentBottom: [
        ...
        { id: 2, name: '风险范围分析', show: false },
        { id: 3, name: '风险分析报告', show: false },
        { id: 4, name: '关联预案', show: false },
    ...
    leftTreeKeys: {
      handler(newVal, oldVal) {
        ...
        if (newVal.keysData.length > 0) {
          ...
          setTimeout(() => {
            this.leftListData = [
              { id: Math.random(), name: '应急事件-待响应', pointType: '1', longitude: 101.493529, latitude: 26.666813, value: '11', valueName: '待执行' },
              { id: Math.random(), name: '应急事件-响应中', pointType: '1', longitude: 101.520651, latitude: 26.648118, value: '12', valueName: '执行中' },
              { id: Math.random(), name: '应急事件-已响应', pointType: '1', longitude: 101.547430, latitude: 26.648118, value: '13', valueName: '已执行' },
              { id: Math.random(), name: '01', pointType: '2', longitude: 101.547630, latitude: 26.668118, value: '21' },
              { id: Math.random(), name: '巡查任务-待执行', pointType: '1', longitude: 103.746691, latitude: 29.556521, value: '11', valueName: '待执行' },
              { id: Math.random(), name: '巡查任务-执行中', pointType: '1', longitude: 103.725405, latitude: 29.539387, value: '12', valueName: '执行中' },
              { id: Math.random(), name: '巡查任务-已执行', pointType: '1', longitude: 103.755961, latitude: 29.522784, value: '13', valueName: '已执行' },
              { id: Math.random(), name: '01', pointType: '2', longitude: 103.547630, latitude: 29.668118, value: '21' }
            ]
          }, 300)
        } else {
          this.leftListData = []
